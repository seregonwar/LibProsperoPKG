...
```bash
dotnet build LibProsperoPKG/legacy/csharp/src/LibProsperoPkg/LibProsperoPkg.csproj -c Release
```
...
```xml
<ItemGroup>
  <ProjectReference Include="..\LibProsperoPKG\legacy\csharp\src\LibProsperoPkg\LibProsperoPkg.csproj" />
</ItemGroup>
```
